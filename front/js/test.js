...
var myInput = document.querySelector("#username");
var myError = document.getElementById("error");

myForm.addEventListener("submit", function(e){
    let myRegExp = /^[a-zA-Z-àâéèêïîôô\s]+$/;
    ...
    } else if (myRegExp.test(myInput.value) == false) {
        alert("Le champs doit contenir uniquement des lettres !");
        e.preventDefault();
...
myForm.addEventListener("change", function(e){
        if (myInput.value == ""){
            myError.textContent = "Le champs est vide !";
            myError.style.color = "red";
            e.preventDefault();
        }
        else {
            myError.textContent = "Le champs est rempli !";
